<div class="col-md-4">
    <div class="card card-outline card-success">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form method="post" action="<?= base_url('petugas/laporanPenarikanHarian'); ?>">
            	<div class="row">
		    		<div class="col-sm-4">
...
<div class="col-md-4">
    <div class="card card-outline card-success">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form method="post" action="<?= base_url('petugas/laporanPenarikanBulanan'); ?>">
	            	<div class="row">
			        	<div class="col-sm-8">
			        		<div class="form-group">
			        			<label>Bulan</label>
...
<div class="col-md-4">
    <div class="card card-outline card-success">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form method="post" action="<?= base_url('petugas/laporanPenarikanTahunan'); ?>">
	            	<div class="row">
			        	<div class="col-sm-8">
			        		<div class="form-group">
			        			<label>Tahun</label>
