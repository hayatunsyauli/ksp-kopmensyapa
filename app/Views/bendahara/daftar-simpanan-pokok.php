    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            <div class="card-tools">
              <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#simppokok"><i class="fas fa-search"></i>&nbsp; Filter
              </button>
                ...
                <table class="table table-sm table-hover table-bordered table_pinjaman" style="font-family: Arial, Helvetica, sans-serif ;border-collapse: collapse;border: 1px solid #dddddd;font-size: 15px;width: 100%; padding-bottom: 10px;">
                  <thead>
                    <tr style="border: 1px solid #dddddd; text-align: center;">
                        ...
                        <th style="border: 1px solid #dddddd;">Simpanan Pokok</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php 
...
<!-- Modal code account-->
<div class="modal fade" id="simppokok" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Filter Simpanan Pokok</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <button type="button" data-dismiss="modal" onclick="viewLapBulanPokok()" class="btn btn-info btn-block">View</button>  
                    </div>
                </div>
                    <!-- 
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <button type="button" data-dismiss="modal" onclick="viewLapTahunPokok()" class="btn btn-info btn-block">View</button>  
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function viewLapBulanPokok(){
        let bulan = $('#bulan').val();
        let tahun = $('#tahun').val();
        // let jns = $('#jenis_simpanan').val();
        if (bulan == '') {
      ...
      /*  else if (jns == '') {
            ...
            $.ajax({
                type: "GET",
                url: "<?= base_url('petugas/viewLapBulanPokok');?>",
                data: {
                    bulan: bulan,
                    tahun: tahun,
                    // jns: jns,
    ...
    function viewLapTahunPokok(){
        ...
        if (tahun == '') {
            ...
            $.ajax({
                type: "GET",
                url: "<?= base_url('petugas/viewLapTahunPokok');?>",
                data: {
                    // bulan: bulan,
                    tahun: tahun,
                },
