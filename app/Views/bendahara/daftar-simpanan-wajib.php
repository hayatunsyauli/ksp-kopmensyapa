    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
              <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#simpwajib"><i class="fas fa-search"></i>&nbsp; Filter
              </button>
                ...
                <table class="table table-sm table-hover table-bordered table_pinjaman" style="font-family: Arial, Helvetica, sans-serif ;border-collapse: collapse;border: 1px solid #dddddd;font-size: 15px;width: 100%; padding-bottom: 10px;">
                  <thead>
                    <tr style="border: 1px solid #dddddd;">
                        ...
                        <th style="border: 1px solid #dddddd;">Simpanan Wajib</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php 
                        ...
                        <tr style="border: 1px solid #dddddd;">
                            ...
                            <td style="text-align: right;">
                                ...
                                < ?php endif ?>
                 -->
                                Rp <?= number_format($s['simpanan_wajib']);?>
...
<!-- Modal code account-->
<div class="modal fade" id="simpwajib" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Filter Simpanan Wajib</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <button type="button" data-dismiss="modal" onclick="viewLapBulanWajib()" class="btn btn-info btn-block">View</button>  
                    </div>
                </div>
                    <!-- 
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <button type="button" data-dismiss="modal" onclick="viewLapTahunWajib()" class="btn btn-info btn-block">View</button>  
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function viewLapBulanWajib(){
        ...
        if (bulan == '') {
            ...
            $.ajax({
                type: "GET",
                url: "<?= base_url('petugas/viewLapBulanWajib');?>",
                data: {
                    bulan: bulan,
                    tahun: tahun,
                },
    ...
    function viewLapTahunWajib(){
        ...
        if (tahun == '') {
            ...
            $.ajax({
                type: "GET",
                url: "<?= base_url('petugas/viewLapTahunWajib');?>",
                data: {
                    // bulan: bulan,
                    tahun: tahun,
                },
