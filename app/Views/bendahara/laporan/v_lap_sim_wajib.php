    <?php 
        if ($simpan == null) {
            ...
            foreach ($simpan as $value) {
                $simpanWajib[] = $value['simpanan_wajib'];
  ...
  <tbody>
    ...
    <?php endforeach; ?>
        <tr>
            ...
            <th class="text-right">Rp <?= number_format(array_sum($simpanWajib));?></th>
        </tr>
        <tr>
            <th colspan="6" class="text-right"><i><?= ucwords(terbilang(array_sum($simpanWajib)));?></i></th>            
        </tr>
  </tbody>
</table>
