    <?php 
        if ($simpan == null) {
            ...
            foreach ($simpan as $value) {
                $simpanSK[] = $value['simpanan_sukarela'];
  ...
  <tbody>
    ...
    <?php endforeach; ?>
        <tr>
            ...
            <th class="text-right">Rp <?= number_format(array_sum($simpanSK));?></th>
        </tr>
        <tr>
            <th colspan="6" class="text-right"><i><?= ucwords(terbilang(array_sum($simpanSK)));?></i></th>
        </tr>
  </tbody>
</table>
