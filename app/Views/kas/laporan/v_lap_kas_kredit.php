<?php 
    if ($kas == null) {
        ...
        foreach ($kas as $value) {
            $kasKredit[] = $value['kas_credit'];
            // $credit[] = $value['kas_credit'];
        }
    } 
    // $saldoakhir = array_sum($Kredit) - array_sum($credit);
?>
<div class="row">
    <div class="col-12">
    ...
    <tbody>
        ...
        <?php } ?>
            <tr>
                ...
                <th class="text-right">Rp <?= number_format(array_sum($kasKredit));?></th>
            </tr>
            <tr>
                <th colspan="6" class="text-right"><i><?= ucwords(terbilang(array_sum($kasKredit)));?></i></th>
            </tr>
    </tbody>
</table> 
