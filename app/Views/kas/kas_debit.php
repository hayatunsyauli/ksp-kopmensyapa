    ...
    <div class="card card-outline card-success">
      <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#kasaccount"><i class="fas fa-search"></i>&nbsp; Filter
            </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <button type="button" data-dismiss="modal" onclick="viewLapBulanKasDebet()" class="btn btn-info btn-block">View</button>  
                    </div>
                </div>
                    <!-- 
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <button type="button" data-dismiss="modal" onclick="viewLapTahunKasDebet()" class="btn btn-info btn-block">View</button>  
                    </div>
                </div>
            </div>
        </div>
